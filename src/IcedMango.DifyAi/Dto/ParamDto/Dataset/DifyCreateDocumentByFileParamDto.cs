...
public class DifyCreateDocumentByFileParamDto
{
    /// <summary>
    ///     Knowledge ID
    /// </summary>
    ...
    ///     When original_document_id is passed in, the update operation is performed on behalf of the document. process_rule is a fillable item. If not filled in, the segmentation method
    ///     of the source document will be used by defaul
