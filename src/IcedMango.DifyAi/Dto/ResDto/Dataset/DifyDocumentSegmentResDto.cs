...
public class DifyDocumentSegmentResDto
{
    [JsonProperty("doc_form")] public string DocForm { get; set; }
    public List<DifyDocumentSegmentsItem> Data { get; set; }
}

public class DifyDocumentSegmentsItem
{
    ...
    [JsonProperty("indexing_at")] [JsonConverter(typeof(UnixTimestampConverter))] public DateTime? IndexingAt { get; set; }
